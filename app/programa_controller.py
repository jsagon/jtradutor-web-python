...
#  Versão 1.0
#
from app import arquivo_controller as arq_controller
...
class Programa (object) :
	...
	def getTranslate (self, indice, word) :
		...
		if indice == 'pt_eng' :
			self.arquivo = arq_controller.Arquivo("app/idiomas_arq/pt_eng.txt")

		elif indice == 'eng_pt' : 
			self.arquivo = arq_controller.Arquivo("app/idiomas_arq/eng_pt.txt")
